...
if __name__ == '__main__':
    ...
    orcaPath = input('Directory of ORCA executable file (e.g. C:\orca\orca.exe): ')
    rootName = input('Directory of the inp file as a model: ')
    modelFile = input('Name of the inp file as a model: ')
    calcPath = input('Directory to be used for calculation: (Should be started AND ended with \ or /): ')
